...
let website = "/MinFSharp"

let githubLink = "http://github.com/theor/MinFSharp"

// Specify more information about your project
let info =
  [ "project-name", "MinFSharp"
    "project-author", "theor"
    "project-summary", "Project has no summmary; update build.fsx"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/MinFSharp" ]
