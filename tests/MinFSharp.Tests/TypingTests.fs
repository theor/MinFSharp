    ...
    type Tcs() =
        static member Data() =
            [| d Type.Int (sInt 42)
               ...
               d Type.Int (LetIn(Syntax.Decl(Id("x"),Type.genType()), pz (sInt 3), Some <| pz(sInt 42)))
               d Type.Int (LetIn(Syntax.Decl(Id("x"),Type.genType()), pz (sInt 3), Some <| pz(varId "x")))
               d Type.Int (LetIn(Syntax.Decl(Id("x"),Type.genType()), pz (sInt 3),
                                 Some <| pz(varId "x")))
               f Type.Int (LetIn(Syntax.Decl(Id("x"),Type.Unit), pz (sInt 3), Some <| pz(varId "x")))
